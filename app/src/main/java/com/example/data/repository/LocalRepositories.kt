...
class LocalUserRepository(private val database: AppDatabase) : UserRepository {
    ...
    override suspend fun activateVip(durationDays: Int) {
        activateVipWithToken(durationDays, "verified_bazaar_${System.currentTimeMillis()}")
    }

    suspend fun activateVipWithToken(durationDays: Int, token: String) {
        val expiry = System.currentTimeMillis() + (durationDays.toLong() * 24 * 60 * 60 * 1000)
        userDao.updateVipStatus(isVip = true, expiry = expiry, token = token)
    }
    ...
    private fun mapEntityToProfile(e: UserProfileEntity): UserProfile {
        ...
        // Security check: VIP is only active if not expired and flagged
        val now = System.currentTimeMillis()
        val isVipValid = e.isVip && (e.vipExpiryTimestamp > now)
...
class LocalChallengeRepository(private val database: AppDatabase) : ChallengeRepository {
    ...
    suspend fun markChallengeCompletedWithScore(id: String, score: Int) {
        challengeDao.markCompletedWithScore(id, score)
    }
    ...
    private fun getSeedChallenges(): List<ChallengeItem> {
        return listOf(
            ChallengeItem(
                ...
                descEn = "Tap target nodes with speed and precision within 30 seconds",
                descFa = "با سرعت و دقت بالا روی گره‌های نئونی ضربه بزنید (۳۰ ثانیه)",
            ...
            ChallengeItem(
                ...
                titleFa = "سرعت محاسبات ریاضی",
                descEn = "Solve rapid mental arithmetic equations without error",
                descFa = "معادلات محاسباتی ذهنی سریع را بدون اشتباه حل کنید (۴۵ ثانیه)",
            ...
            ChallengeItem(
                ...
                titleFa = "یورش سرعتی ۶۰ ثانیه",
                descEn = "Score maximum points against fast spawning golden targets",
                descFa = "بیشترین امتیاز را در برابر گره‌های طلایی سریع کسب کنید",
            ...
            ChallengeItem(
                ...
                titleFa = "دقت تک‌تیرانداز",
                descEn = "High accuracy reaction test. Precision is key to victory!",
                descFa = "چالش سنجش دقت بالا؛ ضربات بدون خطا ضریب امتیاز را به اوج می‌رساند",
            ...
            ChallengeItem(
                ...
                titleFa = "ماراتن بی‌پایان بقا",
                descEn = "Survive as speed ramps up. 120 seconds of pure adrenaline!",
                descFa = "با افزایش مداوم سرعت زنده بمانید؛ ۱۲۰ ثانیه آدرنالین خالص!",
            ...
            ChallengeItem(
                ...
                titleFa = "مسابقات قهرمانی بزرگ آرنا",
                descEn = "Weekly national championship. Compete for the Golden Crown!",
                descFa = "مسابقات قهرمانی بزرگ هفتگی؛ نبرد برای تاج زرین قهرمانان کشوری",
            ...
            ChallengeItem(
                ...
                descFa = "چالش زمانی ویژه جشنواره نئون با دو برابر پاداش سکه و کاپ اختصاصی",
...
class LocalLeaderboardRepository : LeaderboardRepository {
    ...
    override suspend fun submitUserScore(score: Int, type: LeaderboardType) {
        // Stored locally in offline mode
    }
        ...
        emit(
            listOf(
                ...
                RewardItem(
                    ...
                    titleFa = "بسته ۵ عددی بلیت مسابقه",
                    descEn = "Enter 5 championship battles",
                    descFa = "ورود به ۵ نبرد قهرمانی آرنا",
                ...
                RewardItem(
                    ...
                    descFa = "حاوی ۱۵۰۰ سکه + ۵۰۰ XP + ۳ بلیت",
                    type = RewardType.MYSTERY_CHEST,
                    amount = 1,
                    iconSymbol = "👑",
                    coinCost = 950
                ...
                RewardItem(
                    ...
                    titleFa = "هاله درخشان کاربری VIP",
                    descEn = "Exclusive glowing border for your avatar",
                    descFa = "حاشیه درخشان اختصاصی برای پروفایل",
    ...
    private fun getSeedAchievements(): List<AchievementItem> {
        return listOf(
            AchievementItem(
                ...
                descFa = "اولین پیروزی خود در مسابقات آرنا را به دست آورید",
                iconSymbol = "🎖️",
                isUnlocked = true,
                currentProgress = 1,
                targetProgress = 1,
            ...
            AchievementItem(
                ...
                titleFa = "مبارز کهنه‌کار",
                descEn = "Win 10 challenge matches",
                descFa = "۱۰ پیروزی در چالش‌های مختلف به دست آورید",
                iconSymbol = "⚔️",
                isUnlocked = true,
                currentProgress = 10,
                targetProgress = 10,
            ...
            AchievementItem(
                ...
                code = "100_CHALLENGES",
                titleEn = "Centurion",
                titleFa = "سردار صد نبرد",
                descEn = "Participate in 100 arena challenges",
                descFa = "در ۱۰۰ چالش مختلف آرنا شرکت کنید",
                iconSymbol = "🛡️",
                isUnlocked = false,
                currentProgress = 24,
                targetProgress = 100,
            ...
            AchievementItem(
                ...
                titleFa = "تمرکز مطلق و بی‌نقص",
                descEn = "Score 100% accuracy in an Accuracy Challenge",
                descFa = "کسب دقت ۱۰۰٪ در چالش دقت و تمرکز",
                iconSymbol = "🎯",
                isUnlocked = false,
                currentProgress = 0,
                targetProgress = 1,
            ...
            AchievementItem(
                ...
                descFa = "۷ روز متوالی وارد بازی شوید و جایزه بگیرید",
                iconSymbol = "🔥",
                isUnlocked = false,
                currentProgress = 3,
                targetProgress = 7,
            ...
            AchievementItem(
                ...
                titleFa = "ورود به جمع ۱۰۰ برتر",
                descEn = "Climb into the global Top 100 leaderboard",
                descFa = "رسیدن به رتبه ۱۰۰ نفر اول لیدربورد جهانی",
                iconSymbol = "🏆",
                isUnlocked = true,
                currentProgress = 1,
                targetProgress = 1,
            ...
            AchievementItem(
                ...
                titleFa = "شکارچی قله (۱۰ برتر)",
                descEn = "Reach the Top 10 leaderboard in any category",
                descFa = "قرار گرفتن در بین ۱۰ بازیکن برتر کشور",
                iconSymbol = "💎",
                isUnlocked = true,
                currentProgress = 1,
                targetProgress = 1,
            ...
            AchievementItem(
                ...
                titleFa = "قهرمان بلامنازع",
                descEn = "Hold Rank #1 on the weekly tournament leaderboard",
                descFa = "کسب رتبه نخست تورنمنت قهرمانی هفتگی",
                iconSymbol = "👑",
                isUnlocked = false,
                currentProgress = 0,
                targetProgress = 1,
