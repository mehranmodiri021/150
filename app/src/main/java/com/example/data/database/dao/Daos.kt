...
interface UserDao {
    ...
    @Query("UPDATE user_profile SET isVip = :isVip, vipExpiryTimestamp = :expiry, vipPurchaseToken = :token WHERE id = :id")
    suspend fun updateVipStatus(isVip: Boolean, expiry: Long, token: String, id: String = "primary_user")
}
...
interface ChallengeDao {
    ...
    @Query("UPDATE challenges SET isCompleted = 1, bestScore = CASE WHEN :score > bestScore THEN :score ELSE bestScore END WHERE id = :id")
    suspend fun markCompletedWithScore(id: String, score: Int)
