...
enum class RankTier(
    ...
    BRONZE(
        ...
        perksFa = "دسترسی به جوایز استاندارد و چالش‌های مقدماتی"
    ),
    SILVER(
        tierLevel = 2,
        titleEn = "Silver",
        ...
        perksFa = "+۵٪ پاداش XP و بازگشایی چالش‌های روزانه"
    ),
    GOLD(
        tierLevel = 3,
        titleEn = "Gold",
    ...
    PLATINUM(
        ...
        perksFa = "+۱۵٪ پاداش XP و دسترسی به چالش‌های سرعتی پیشرفته"
    ),
    DIAMOND(
        tierLevel = 5,
        titleEn = "Diamond",
        ...
        perksFa = "+۲۰٪ پاداش، نشان الماس در لیدربورد و رویدادهای ویژه"
    ),
    MASTER(
        tierLevel = 6,
        titleEn = "Master",
        ...
        perksFa = "+۲۵٪ پاداش XP و حضور در جمع اساتید برتر"
    ),
    GRANDMASTER(
        tierLevel = 7,
        titleEn = "Grandmaster",
        ...
        perksFa = "+۳۰٪ پاداش XP و هاله درخشان اختصاصی"
    ),
    LEGEND(
        tierLevel = 8,
        titleEn = "Legend",
        ...
        perksFa = "بالاترین رتبه ممکن، حداکثر جوایز و تالار افتخارات"
    );

    val stageNumber: Int get() = tierLevel
