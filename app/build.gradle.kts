...
android {
  // اصلاح نام‌فضا (Namespace) برای تطابق کامل با Application ID و جلوگیری از خطاهای کامپایل منابع
  namespace = "com.aistudio.arenaclash.bazaar"
  compileSdk = 36
  ...
  signingConfigs {
    create("release") {
      ...
      val store = if (!keystoreEnv.isNullOrBlank() && file(keystoreEnv).exists()) {
        file(keystoreEnv)
